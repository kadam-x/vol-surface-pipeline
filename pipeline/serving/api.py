...
DB_PATH = os.getenv("DUCKDB_PATH", "/data/warehouse/vol_surface.db")
...
def get_vol_surface(ticker: str, snapshot_date: Optional[str] = None):
    """
    Full IV surface: all expiries, all strikes for a ticker.
    """
...
def get_term_structure(ticker: str, snapshot_date: Optional[str] = None, expiry_bucket: Optional[str] = None):
    """
...
def get_tickers():
    ...
    query = "SELECT DISTINCT dt.symbol FROM dim_ticker dt"
